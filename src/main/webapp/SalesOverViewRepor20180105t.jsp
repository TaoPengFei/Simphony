					...
					<div class="container-fluid">
						<div class="row-fluid" style="margin-top:0px">
							<div class="span4">
								...
								<div class="controls">
									<input id="rctSel" type="text" readonly value="All" style="width:190px;line-height: 30px;background-color: #fff;" onclick="showrctMenu(); return false;"/>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container-fluid">
						<div class="row-fluid" style="margin-top:0px">
							<div class="span4">
								...
								<div class="controls">
									<input id="Sel_ord" type="text" readonly value="All" style="width:190px;line-height: 30px;background-color: #fff;" onclick="showMenu_ord(); return false;"/>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container-fluid">
						<div class="row-fluid" style="margin-top:0px">
							<div class="span4">
								...
								<div class="controls">
									<input id="citySel" type="text" readonly value="All" style="width:190px;line-height: 30px;background-color: #fff;" onclick="showMenu(); return false;"/>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container-fluid">
						<div class="row-fluid" style="margin-top:0px">
							<div class="span4">
								...
								<div class="controls">
									<input id="Sel_ted" type="text" readonly value="All" style="width:190px;line-height: 30px;background-color: #fff;" onclick="showMenu_ted(); return false;"/>
								</div>
							</div>
						</div>
					</div>
				...
				var bindEvents = function(){
					$("#btn").bind("click",function( e, treeId, treeNode ){
			            ...
			            //alert(nodeId);
				          ...
				          nodes_ted = zTree_ord.getCheckedNodes(true),
				          v_ted = "";
				          var nodeId_ted = "";
				          nodeLevel_ted = "";
